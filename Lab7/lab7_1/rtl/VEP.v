...
wire [2:0] Axf=(VEP_x>=winner_VEP_x)?VEP_x:winner_VEP_x;
wire [2:0] Axb=(VEP_x>=winner_VEP_x)?winner_VEP_x:VEP_x;
wire [2:0] Ax=Axf-Axb;
wire [2:0] Ayf=(VEP_y>=winner_VEP_y)?VEP_y:winner_VEP_y;
wire [2:0] Ayb=(VEP_y>=winner_VEP_y)?winner_VEP_y:VEP_y;
wire [2:0] Ay=Ayf-Ayb;
...
always@(*)
	if(VEP_x==winner_VEP_x && VEP_y==winner_VEP_y)
		weight_b2=weight_b>>>2;
	else if((VEP_x==winner_VEP_x && Ay==3'd1) || (VEP_y==winner_VEP_y && Ax==3'd1))
		weight_b2=weight_b>>>3;
	else if((VEP_x==winner_VEP_x && Ay==3'd2) || (VEP_y==winner_VEP_y && Ax==3'd2) || (Ay==3'd1 && Ax==3'd1))
		weight_b2=weight_b>>>4;
	else
		weight_b2=9'd0;

always@(*)
	if(VEP_x==winner_VEP_x && VEP_y==winner_VEP_y)
		weight_g2=weight_g>>>2;
	else if((VEP_x==winner_VEP_x && Ay==3'd1) || (VEP_y==winner_VEP_y && Ax==3'd1))
		weight_g2=weight_g>>>3;
	else if((VEP_x==winner_VEP_x && Ay==3'd2) || (VEP_y==winner_VEP_y && Ax==3'd2) || (Ay==3'd1 && Ax==3'd1))
		weight_g2=weight_g>>>4;
	else
		weight_g2=9'd0;

always@(*)
	if(VEP_x==winner_VEP_x && VEP_y==winner_VEP_y)
		weight_r2=weight_r>>>2;
	else if((VEP_x==winner_VEP_x && Ay==3'd1) || (VEP_y==winner_VEP_y && Ax==3'd1))
		weight_r2=weight_r>>>3;
	else if((VEP_x==winner_VEP_x && Ay==3'd2) || (VEP_y==winner_VEP_y && Ax==3'd2) || (Ay==3'd1 && Ax==3'd1))
		weight_r2=weight_r>>>4;
	else
		weight_r2=9'd0;
